...
import { SESSIONS, WEEKLY_CRON, MONTHLY_RANK_CRON, TIMEZONE } from './config.js';
import { startSession, finalizeSession } from './attendance.js';
import { runWeeklyCheck } from './warnings.js';
import { postMonthlyRanking } from './ranking.js';
...
export function registerSchedules(ctx) {
  ...
  cron.schedule(MONTHLY_RANK_CRON, () => postMonthlyRanking(ctx), opt);
